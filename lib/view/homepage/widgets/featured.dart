...
class Featured extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<ProviderCoursess>(builder: (context, value, _) {
      return RefreshIndicator(
        child: value.loading == true ||
            ...
            : value.eroor == true ||
                    ...
                    Provider.of<MyLearningsController>(context).error == true ||
                    Provider.of<UserDetails>(context).eroor == true
   ...
   // ${Provider.of<UserDetails>(context,listen: false ).userDetailslist[0].userDetails!.name}",
                                        color: kblack,
                                        size: 16),
                                    Ktext(
                              ...
                              children: [
                                ...List.generate(
                                    ...
                                    (index) => ActionChip(
                                          ...
                                          label: Text(value.categoryList[index]
                                              .toString()),
                                          onPressed: () {
