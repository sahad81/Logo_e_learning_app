    ...
    return Scaffold(
      ...
      child: Padding(
        ...
        child: Column(
         ...
         Column(
          crossAxisAlignment: CrossAxisAlignment.stretch,
           children: [
              Ktext(text:  "L O G O", color: kblack, size: 30,weight: FontWeight.bold),
              kheight15,
         Ktext(text: "Welcome back! ", color: kwite, size: 25,weight: FontWeight.bold,),
           ],
         ),
         kheight30,
            TextFormField(
        ...
        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
             Container(width: 130,height: 1,color: kwite,),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [Ktext(text: "Already have an account?", color: kwite, size: 15),
                   TextButton(onPressed: () {
                      Navigator.push(  
          context,  
          MaterialPageRoute(builder: (context) => LoginPage())); 
                   }, child:  Ktext(text: "Log in", color: Colors.blue.shade900, size: 15),),
                ],),
              ],
            ),
          ),
